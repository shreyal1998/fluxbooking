...
export function ScheduleClient({ staff, tenant, userRole, defaultStaffId, defaultView = "week", serverDateIso, defaultSlotDuration = 60, initialZoomLevel = 100, userId }: any) {
