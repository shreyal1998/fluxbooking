...
export function LeaveRequestsManager({ initialRequests, timeFormat = "12h" }: { initialRequests: any[], timeFormat?: string }) {
  ...
  if (requests.length === 0) {
    return (
      <div className="bg-slate-50 dark:bg-slate-900/50 border border-dashed border-slate-100 dark:border-slate-800 p-12 rounded-[2rem] text-center transition-colors">
