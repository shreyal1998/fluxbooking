          ...
          <button
            ...
            className={`flex flex-col items-center gap-3 p-6 rounded-2xl border-2 transition-all duration-200 ${
              isActive 
                ...
                : "bg-white border-slate-200 text-slate-500 hover:border-indigo-200 hover:bg-indigo-50/30 dark:bg-slate-900 dark:border-slate-700 dark:text-slate-400 dark:hover:border-slate-700 dark:hover:bg-slate-800/50"
            }`}
          >
